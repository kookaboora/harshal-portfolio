      ...
      <div className="relative z-10 max-w-6xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-12">
        ...
        >
          ...
          <p className="text-lg leading-relaxed text-gray-300 max-w-xl">
            I'm Harshal Patel, a Fullstack Developer with 3 years of experience crafting interactive, scalable, and visually compelling web apps. I love blending modern frontend design with robust backend logic — and lately, I’ve been diving into AI to supercharge user experiences.
          </p>
